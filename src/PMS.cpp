    ...
    default:
      ...
      else if (_index == _frameLen + 2 + 1)
      {
        ...
        if (_calculatedChecksum == _checksum)
        {
          ...
          if (_frameLen == 2 * 13 + 2)
          {
            // Particle count per size bucket.
            _data->PC_0_3 = makeWord(_payload[12], _payload[13]);
		        _data->PC_0_5 = makeWord(_payload[14], _payload[15]);
		        _data->PC_1_0 = makeWord(_payload[16], _payload[17]);
		        _data->PC_2_5 = makeWord(_payload[18], _payload[19]);
		        _data->PC_5_0 = makeWord(_payload[20], _payload[21]);
		        _data->PC_10_0 = makeWord(_payload[22], _payload[23]);
          }
        }
      ...
      else
      {
        ...
        // Payload's first 2x6 bytes are common to all sensors, next bytes only for newer versions.
